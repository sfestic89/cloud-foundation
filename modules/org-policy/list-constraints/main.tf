    ...
    dynamic "rules" {
      ...
      content {
        values {
          ...
          allowed_values = try(each.value.else_behavior, "allow_all") == "allowed_values" ? true : null
          denied_values  = try(each.value.else_behavior, "allow_all") == "denied_values" ? true : null
